...
// use App\View\Components\Dashboard\Alert;
...
class NotificationListController extends Controller
{
    ...
    public function index(){
        ...
        return view('dashboard.admin.notification.list.index' , compact(['notification_types'  ]));
    }
    ...
    public function type($id){
        ...
        return view('dashboard.admin.notification.list.type' , compact(['notification_lists' , 'notification_type'  ]));
