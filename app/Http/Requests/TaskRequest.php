            ...
            if (!empty($this->id))
                $existing_tasks = $existing_tasks
                    ...
                    if (in_array($this->method(), ['POST'])) {
                        ...
                        $newstring="دقت نمایید تایم آزاد کاربر از تاریخ ".$tarikh." به بعد می باشد";
                        // $validator->errors()->add('start_date', 'در بازه زمانی مشخص‌شده مسئولیت‌های دیگری وجود دارند! در صورت تایید، هنگام ساخت یا ویرایش مسئولیت، تیک "صرف‌نظر کردن از تداخل زمانی" را بزنید.'.$newstring);
                        $validator->errors()->add('start_date', 'در بازه زمانی مشخص‌شده مسئولیت‌های دیگری وجود دارند!  .'.' '.$newstring);
                        }
