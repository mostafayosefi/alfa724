                    ...
                    <tr>
                     ...
                     @foreach($price_my_service as $item)
                        <tr>
                            ...
                            @php dd($item->my_service); @endphp

                            <td>{{ $item->my_service->id }}</td>
                            <td>{{ $item->my_service->id }}</td>
                            <td>{{ $item->my_service->id }}</td>
                            <td>{{ $item->my_service->id }}</td>
                            <td>{{ $item->my_service->id }}</td>
                                        ...
                                        <div class="modal-footer justify-content-between">
                                          <button type="button" class="btn btn-outline-light uncheckd" data-dismiss="modal">خیر</button>
                                           <form  action="#" method="post">
                                              ...
                                              <a href="{{route('dashboard.admin.employee.deleteemployee',['id'=>$item->id,'project_id'=>$item->id])}}" class="btn btn-outline-light">بله </a>
                                           </form>
                                        </div>
                                      </div>
                                      <!-- /.modal-content -->
