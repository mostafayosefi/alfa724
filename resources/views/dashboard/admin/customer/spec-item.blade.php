...
<div style="margin-top:50px"></div>
      <div class="form-group">
        ...
        <td>
          ...
          <div class="form-group">
            <label for="a1">نام خدمات  </label>
            <input required name="specifications[{{ !empty($specification) ? $idx : 'IDX' }}][name]"
            value="{{ !empty($name) ? $name : (!empty($specification) ? $specification->key : '' )}}"
            type="text" id="name{{ !empty($specification) ? $idx : 'IDX' }}" class="form-control datee" requierd placeholder="نام خدمات">
        </div>
        ...
        <td>
          ...
          <div class="form-group">
            <label for="a2">تعداد    </label>
            <input required name="specifications[{{ !empty($specification) ? $idx : 'IDX' }}][count]"
            value="{{ !empty($count) ? $count : (!empty($specification) ? $specification->key : '' )}}"
             type="text" id="count{{ !empty($specification) ? $idx : 'IDX' }}" class="form-control datee" requierd placeholder="تعداد">
          </div>
        ...
        <td>
          ...
          <div class="form-group">
            <label for="a3">هزینه پروژه   </label>
            <input required name="specifications[{{ !empty($specification) ? $idx : 'IDX' }}][price]"
            value="{{ !empty($price) ? $price : (!empty($specification) ? $specification->key : '' )}}"
            type="text" id="price{{ !empty($specification) ? $idx : 'IDX' }}" class="form-control datee" requierd placeholder="هزینه پروژه">
        ...
        <td>
          ...
          <div class="form-group">
            <label for="a4">  مدت روزکاری    </label>
            <input required name="specifications[{{ !empty($specification) ? $idx : 'IDX' }}][time]"
            value="{{ !empty($time) ? $time : (!empty($specification) ? $specification->key : '' )}}"
            type="text" id="time{{ !empty($specification) ? $idx : 'IDX' }}" class="form-control datee" placeholder="مدت روزکاری">
          </div>
        ...
        <td>
          ...
          <div class="form-group">
            <label for="a5">  تاریخ شروع   </label>
            <input required name="specifications[{{ !empty($specification) ? $idx : 'IDX' }}][start_date]"
            value="{{ !empty($start_date) ? $start_date : (!empty($specification) ? $specification->key : '' )}}"
            type="text" id="start_date{{ !empty($specification) ? $idx : 'IDX' }}" class="form-control datee"  placeholder="تاریخ شروع 1400/12/05">
          </div>
        ...
        <td>
          ...
          <div class="form-group">
            <label for="a6">  تاریخ پایان   </label>
            <input required name="specifications[{{ !empty($specification) ? $idx : 'IDX' }}][end_date]"
            value="{{ !empty($end_date) ? $end_date : (!empty($specification) ? $specification->key : '' )}}"
            type="text" id="end_date{{ !empty($specification) ? $idx : 'IDX' }}" class="form-control datee"  placeholder="تاریخ پایان 1400/12/05">
...
<tr>
      ...
      <div class="form-group">
        ...
        <td>
          ...
          <div class="form-group">
            <label for="a7">تاریخ تحویل    </label>
            <input  name="specifications[{{ !empty($specification) ? $idx : 'IDX' }}][final_date]"
            value="{{ !empty($final_date) ? $final_date : (!empty($specification) ? $specification->key : '' )}}"
            type="text" id="final_date{{ !empty($specification) ? $idx : 'IDX' }}" class="form-control datee"  placeholder="تاریخ تحویل">
          </div>
        ...
        <td>
          ...
          <div class="form-group">
            <label for="a8">تاریخ تسویه    </label>
            <input  name="specifications[{{ !empty($specification) ? $idx : 'IDX' }}][purchase_date]"
            value="{{ !empty($purchase_date) ? $purchase_date : (!empty($specification) ? $specification->key : '' )}}"
            type="text" id="purchase_date{{ !empty($specification) ? $idx : 'IDX' }}" class="form-control datee"  placeholder="تاریخ تسویه">
          </div>
