                                                ...
                                                <div class="row justify-content-end align-items-center">
                                                    <div
                                                        ...
                                                        <div class="btn-group" role="group" aria-label="مثال">
                                                            ...
                                                            @else
                                                                <a href="{{ env('APP_URL') }}/user/date/{{ $month->month_year }}/{{ $month->month_month + 1 }}"
                                                                    class="fullcalendar-btn-prev btn btn-sm btn-primary"
                                                                    title="ماه بعد">
                                                                    <i class="fa fa-angle-right"></i>
                                                                </a>
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                data-calendar-view="month">{{ $month->month_namemonth }}
                                                                {{ $month->month_year }}</a>
                                                                                                            ...
                                                                                                            <table
                                                                                                                ...
                                                                                                                <tbody>
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td @if ($month->month_year == $todayshamsi->year &&
                                                                                                                            $month->month_month == $todayshamsi->month &&
                                                                                                                            $j + 7 == $todayshamsi->day) class="fc-day fc-widget-content  fc-other-month fc-today " @else class="fc-day-top fc-future" @endif
                                                                                                                            data-date="2020-07-09">
                                                                                                                        </td>

                                                                                                                        <td @if ($month->month_year == $todayshamsi->year &&
                                                                                                                            $month->month_month == $todayshamsi->month &&
                                                                                                                            $j + 6 == $todayshamsi->day) class="fc-day fc-widget-content  fc-other-month fc-today " @else class="fc-day-top fc-future" @endif
                                                                                                                            data-date="2020-07-09">
                                                                                                                        </td>

                                                                                                                        <td @if ($month->month_year == $todayshamsi->year &&
                                                                                                                            $month->month_month == $todayshamsi->month &&
                                                                                                                            $j + 5 == $todayshamsi->day) class="fc-day fc-widget-content  fc-other-month fc-today " @else class="fc-day-top fc-future" @endif
                                                                                                                            data-date="2020-07-09">
                                                                                                                        </td>

                                                                                                                        <td @if ($month->month_year == $todayshamsi->year &&
                                                                                                                            $month->month_month == $todayshamsi->month &&
                                                                                                                            $j + 4 == $todayshamsi->day) class="fc-day fc-widget-content  fc-other-month fc-today " @else class="fc-day-top fc-future" @endif
                                                                                                                            data-date="2020-07-09">
                                                                                                                        </td>

                                                                                                                        <td @if ($month->month_year == $todayshamsi->year &&
                                                                                                                            $month->month_month == $todayshamsi->month &&
                                                                                                                            $j + 3 == $todayshamsi->day) class="fc-day fc-widget-content  fc-other-month fc-today " @else class="fc-day-top fc-future" @endif
                                                                                                                            data-date="2020-07-09">
                                                                                                                        </td>

                                                                                                                        <td @if ($month->month_year == $todayshamsi->year &&
                                                                                                                            $month->month_month == $todayshamsi->month &&
                                                                                                                            $j + 2 == $todayshamsi->day) class="fc-day fc-widget-content  fc-other-month fc-today " @else class="fc-day-top fc-future" @endif
                                                                                                                            data-date="2020-07-09">
                                                                                                                        </td>

                                                                                                                        <td @if ($month->month_year == $todayshamsi->year &&
                                                                                                                            $month->month_month == $todayshamsi->month &&
                                                                                                                            $j + 1 == $todayshamsi->day) class="fc-day fc-widget-content  fc-other-month fc-today " @else class="fc-day-top fc-future" @endif
                                                                                                                            data-date="2020-07-09">
                                                                                                                        </td>
                                                                                                            ...
                                                                                                            <table>
                                                                                                                <thead>
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td @if ($j + 7 < 1 || $j + 7 > $month_daymonth) class="fc-day-top fc-other-month fc-past" @else class="fc-day-top fc-future" @endif
                                                                                                                            data-date="2020-07-01">
                                                                                                                            <span
                                                                                                                                class="fc-day-number">
                                                                                                                                @if ($j + 7 < 1)
                                                                                                                                    {{ $month_dayprev + $n + 7 }}
                                                                                                                                @elseif($j + 7 > $month_daymonth)
                                                                                                                                    {{ $j + 7 - $month_daymonth }}
                                                                                                                                @else
                                                                                                                                    {{ $j + 7 }}
                                                                                                                                @endif
                                                                                                                            ...
                                                                                                                            @foreach ($calendarrezervs as $calendarrezerv)
                                                                                                                                @if ($calendarrezerv->cal_day == $j + 7)
                                                                                                                                    <?php $pes_over = $calendarrezerv->cal_pes - $calendarrezerv->cal_pesreg; ?>
                                                                                                                                    @if ($pes_over > 0)
                                                                                                                                        <a href="#"
                                                                                                                                            data-toggle="modal"
                                                                                                                                            data-target="#rezervd{{ $calendarrezerv->cal_id }}"
                                                                                                                                            class="fc-day fc-widget-content  fc-other-month fc-today ">
                                                                                                                                            <button
                                                                                                                                                type="submit"
                                                                                                                                                style="background-color: #cb34a9; color: #ffffff;  direction: rtl;">{{ $calendarrezerv->cal_hours }}</button>
                                                                                                                                        </a>
                                                                                                                                    @else
                                                                                                                                        <a href="#"
                                                                                                                                            data-toggle="modal"
                                                                                                                                            ...
                                                                                                                                            <button
                                                                                                                                                type="submit"
                                                                                                                                                style="background-color: #000000; color: #ffffff;  direction: rtl;">
                                                                                                                                                تکمیل
                                                                                                                                                شد</button>
                                                                                                                                        </a>
                                                                                                                                    @endif
                                                                                                                        ...
                                                                                                                        <td @if ($j + 6 < 1 || $j + 6 > $month_daymonth) class="fc-day-top fc-other-month fc-past" @else class="fc-day-top fc-future" @endif
                                                                                                                            data-date="2020-07-01">
                                                                                                                            <span
                                                                                                                                class="fc-day-number">
                                                                                                                                @if ($j + 6 < 1)
                                                                                                                                    {{ $month_dayprev + $n + 6 }}
                                                                                                                                @elseif($j + 6 > $month_daymonth)
                                                                                                                                    {{ $j + 6 - $month_daymonth }}
                                                                                                                                @else
                                                                                                                                    {{ $j + 6 }}
                                                                                                                                @endif
                                                                                                                        ...
                                                                                                                        <td @if ($j + 5 < 1 || $j + 5 > $month_daymonth) class="fc-day-top fc-other-month fc-past" @else class="fc-day-top fc-future" @endif
                                                                                                                            data-date="2020-07-01">
                                                                                                                            <span
                                                                                                                                class="fc-day-number">
                                                                                                                                @if ($j + 5 < 1)
                                                                                                                                    {{ $month_dayprev + $n + 5 }}
                                                                                                                                @elseif($j + 5 > $month_daymonth)
                                                                                                                                    {{ $j + 5 - $month_daymonth }}
                                                                                                                                @else
                                                                                                                                    {{ $j + 5 }}
                                                                                                                                @endif
                                                                                                                        ...
                                                                                                                        <td @if ($j + 4 < 1 || $j + 4 > $month_daymonth) class="fc-day-top fc-other-month fc-past" @else class="fc-day-top fc-future" @endif
                                                                                                                            data-date="2020-07-01">
                                                                                                                            <span
                                                                                                                                class="fc-day-number">
                                                                                                                                @if ($j + 4 < 1)
                                                                                                                                    {{ $month_dayprev + $n + 4 }}
                                                                                                                                @elseif($j + 4 > $month_daymonth)
                                                                                                                                    {{ $j + 4 - $month_daymonth }}
                                                                                                                                @else
                                                                                                                                    {{ $j + 4 }}
                                                                                                                                @endif
                                                                                                                        ...
                                                                                                                        <td @if ($j + 3 < 1 || $j + 3 > $month_daymonth) class="fc-day-top fc-other-month fc-past" @else class="fc-day-top fc-future" @endif
                                                                                                                            data-date="2020-07-01">
                                                                                                                            <span
                                                                                                                                class="fc-day-number">
                                                                                                                                @if ($j + 3 < 1)
                                                                                                                                    {{ $month_dayprev + $n + 3 }}
                                                                                                                                @elseif($j + 3 > $month_daymonth)
                                                                                                                                    {{ $j + 3 - $month_daymonth }}
                                                                                                                                @else
                                                                                                                                    {{ $j + 3 }}
                                                                                                                                @endif
                                                                                                                        ...
                                                                                                                        <td @if ($j + 2 < 1 || $j + 2 > $month_daymonth) class="fc-day-top fc-other-month fc-past" @else class="fc-day-top fc-future" @endif
                                                                                                                            data-date="2020-07-01">
                                                                                                                            <span
                                                                                                                                class="fc-day-number">
                                                                                                                                @if ($j + 2 < 1)
                                                                                                                                    {{ $month_dayprev + $n + 2 }}
                                                                                                                                @elseif($j + 2 > $month_daymonth)
                                                                                                                                    {{ $j + 2 - $month_daymonth }}
                                                                                                                                @else
                                                                                                                                    {{ $j + 2 }}
                                                                                                                                @endif
                                                                                                                        ...
                                                                                                                        <td @if ($j + 1 < 1 || $j + 1 > $month_daymonth) class="fc-day-top fc-other-month fc-past" @else class="fc-day-top fc-future" @endif
                                                                                                                            data-date="2020-07-01">
                                                                                                                            <span
                                                                                                                                class="fc-day-number">
                                                                                                                                @if ($j + 1 < 1)
                                                                                                                                    {{ $month_dayprev + $n + 1 }}
                                                                                                                                @elseif($j + 1 > $month_daymonth)
                                                                                                                                    {{ $j + 1 - $month_daymonth }}
                                                                                                                                @else
                                                                                                                                    {{ $j + 1 }}
                                                                                                                                @endif
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p><b>تاریخ آزمون : {{ $calendarrezerv->cal_day }} {{ $month->month_namemonth }}
                                {{ $month->month_year }}</b></p>
                        <p><b>ساعت آزمون : {{ $calendarrezerv->cal_hours }}</b></p>
                        <p><b> ظرفیت باقی مانده : {{ $calendarrezerv->cal_pes - $calendarrezerv->cal_pesreg }} نفر </b>
                        </p>
                    ...
                    <form class="forms-sample" action="{{ env('APP_URL') }}/user/rezervd" method="post">
                        ...
                        <input type="hidden" name="cal_pesover"
                            value="{{ $calendarrezerv->cal_pes - $calendarrezerv->cal_pesreg }}">
